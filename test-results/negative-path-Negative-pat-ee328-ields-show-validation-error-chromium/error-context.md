...
- Name: negative-path.spec.js >> Negative path validation >> teacher-setup – empty fields show validation error
- Location: negative-path.spec.js:95:3
...
```yaml
- main:
  - heading "Teacher Account Setup" [level=3]
  - paragraph: Choose your username and password to activate your teacher account.
  - text: Email
  - textbox [disabled]
  - text: Username
  - textbox
