...
- Name: negative-path.spec.js >> Negative path validation >> reset-password – empty/malformed fields show validation error
- Location: negative-path.spec.js:63:3
...
- main [ref=e2]:
  - generic [ref=e4]:
    - heading " Reset Password" [level=3] [ref=e5]:
      - generic [ref=e6]: 
      - text: Reset Password
    - generic [ref=e7]:
      - generic [ref=e8]:
        - generic [ref=e9]: Email
        - textbox [ref=e10]: bad-email
      - generic [ref=e11]:
        - generic [ref=e12]: New Password
        - textbox [ref=e13]: "123"
      - generic [ref=e14]:
        - generic [ref=e15]: Confirm New Password
        - textbox [active] [ref=e16]: "456"
      - button "Reset Password" [ref=e17] [cursor=pointer]
```
