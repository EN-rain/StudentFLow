...
- Name: negative-path.spec.js >> Negative path validation >> forgot-password – malformed email shows validation error
- Location: negative-path.spec.js:55:3
...
```yaml
- main:
  - heading "Reset Password" [level=3]
  - text: Email
  - textbox: bad-email
