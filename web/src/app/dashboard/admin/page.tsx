    ...
    <>
      <div className="page-header">
        <div>
          ...
          <p>Overview of the school system</p>
        </div>
      </div>
      ...
      <div className="row g-3 mb-4">
        <div className="col-md-3">
          <div className="card stat-card"><div className="card-body">
            ...
            <div className="stat-value text-primary">{stats.total_students}</div>
          </div></div>
        </div>
        <div className="col-md-3">
          <div className="card stat-card"><div className="card-body">
            <div className="stat-label">Total Classes</div>
            <div className="stat-value text-info">{stats.total_classes}</div>
          </div></div>
        </div>
        <div className="col-md-3">
          <div className="card stat-card"><div className="card-body">
            <div className="stat-label">Total Teachers</div>
            <div className="stat-value text-success">{stats.total_teachers}</div>
          </div></div>
        </div>
        <div className="col-md-3">
          <div className="card stat-card"><div className="card-body">
        ...
        <div className="col-md-6">
          <div className="card stat-card"><div className="card-body">
            ...
            {stats.recent_announcements.length === 0 && (
              <p className="text-muted mb-0">No recent announcements.</p>
            )}
            {stats.recent_announcements.map((a) => (
              <div key={a.id} className="mb-1">
                <span className={`badge bg-${a.priority === "Urgent" ? "danger" : a.priority === "Important" ? "warning" : "secondary"} me-1`}>
                  {a.priority}
                </span>
                {a.title}
              </div>
